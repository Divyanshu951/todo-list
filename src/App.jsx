  ...
  return (
    <div className="flex min-h-screen flex-col bg-stone-950 text-stone-200">
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-5 md:py-12">
        <button
          className="sticky top-2 z-5 mb-5 w-full cursor-pointer rounded-2xl border border-amber-700/50 bg-stone-900/80 px-2 py-2 text-xl font-medium tracking-wide text-amber-500 shadow-xl backdrop-blur-md transition-all duration-300 hover:scale-[1.01] hover:bg-stone-800 disabled:opacity-50 md:mb-10 md:px-4 md:py-4"
